...
import { Phone, PhoneCall, Copy, Check, Search, Shield, AlertTriangle, LifeBuoy, Wrench, HeartPulse, Building2, ExternalLink, X, Info } from 'lucide-react';
import { EMERGENCY_CONTACTS, EmergencyContact, EmergencyCategory } from '../data/emergencyDirectory';
